...
Can cu Ke hoach giang day – hoc tap hoc ky 1 nam hoc 2021 – 2022 Can cu ket qua thi hoc ky 2 va hoc
Hoc vien Cong nghe Buu chinh Vien thong to chuc khai giang truc tuye
*/
#include <iostream>
#include <string>
#include <vector>
...
int main () {
    ...
    while (t--) {
        ...
        for (int i = 0; i < a.size(); i++) {
            if (res.length() + a[i].length() + 1 <= 100) {
                res += a[i] + " ";
            }
            else {
                break;
